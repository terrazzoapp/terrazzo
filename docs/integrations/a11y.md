...
| :------------------------------ | :-----: | :------------------------------------------------------------------------------------------------------------------------------------------------- |
| [a11y/contrast](#a11y-contrast) | `"off"` | Run WCAG2 and APCA contrast checks on all of your tokens (you have to manually specify the pairs, but it will work on any tokens in `tokens.json`) |
