...
While his solution of an OKHSL colorpicker is a great compromise, it limits colorpicking to that color space alone. In order to be universally-usable for all color spaces, per-channel sliders are needed for control.
