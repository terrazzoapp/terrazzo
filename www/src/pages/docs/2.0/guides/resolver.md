...
No! You can actually have 1 `.resolver.json` file that declares all of your tokens, sets, and modifiers with no external references. See the [bundling guide](https://www.designtokens.org/tr/2025.10/resolver/#bundling) in the specification for more info.
