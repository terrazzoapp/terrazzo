...
A resolver is a **meta document** that describes how all your token files relate to one another in one design system. Here’s what an example would look like, using our example from the previous section:
