...
Writing your own linter is easy! Terrazzo’s lint API is heavily-inspired by ESLint, but even simpler. See [the plugin section on linting](/docs/reference/plugin-api#lint) to get started.
