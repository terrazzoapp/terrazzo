...
describe('vanilla-extract', () => {
  ...
  describe('examples', () => {
    ...
    it.each(examples)(
      ...
      120_000,
    ); // these are doing large builds + building with Vite. They may take extra time in CI
  });
  ...
  describe('options', () => {
    it('throws error on array key', () => {
      expect(() =>
        ...
        '"foo-bar" must be a valid JS identifier. Prefer camelCase so it may be used in JS.',
      );
    });
