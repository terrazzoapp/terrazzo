...
console.log(evaluate(document)); // produce in-memory JSON object
console.log(print(document)); // produce JSON string, with original indentation and everything preserved
