...
export default function Layout({ children }: LayoutProps) {
  return (
    <div className={c.layout}>
      ...
      <section className={c.topNav}>
        <header className={c.topNavInner}>
          <Button>+ New</Button>
        </header>
      </section>
